...
role :web, "railsforum.com"                          # Your HTTP server, Apache/etc
role :app, "railsforum.com"                         # This may be the same as your `Web` server
role :db,  "railsforum.com"   , :primary => true # This is where Rails migrations will run
